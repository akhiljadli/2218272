...
export const URLProvider = ({ children }) => {
  const [urls, setUrls] = useState([]); // { shortCode, longUrl, createdAt, expiresAt, custom, visits: [] }

  // Helper: Check if a shortcode is unique
  ...
  // Handle a redirect (increment analytics, check expiry)
